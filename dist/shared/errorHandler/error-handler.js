...
const error_name_table_1 = require("./enums/error-name-table");
/**
 ...
 */
function errorHandler({ message, stack, name, }) {
    const isDebugMode = process.env.DEBUG_MODE === "true";
    const code = error_name_table_1.errorNamesToStatusCode[name] || null;
    const errorResponse = {
        errMessage: message,
        errStatusCode: code || status_code_1.statusCode.INTERNAL_SERVER_ERROR,
    };
    if (isDebugMode) {
